...
- Сейчас конец апреля 2026. Идёт плей-офф NBA 2025-26, ПЕРВЫЙ РАУНД. Регулярный сезон закончился. Не путай даты регулярки с плей-офф!
- Серии первого раунда (до 4 побед): BOS vs PHI, CLE vs TOR, NYK vs ATL, DET vs ORL, OKC vs PHX, LAL vs HOU, DEN vs MIN, SAS vs POR
- Лейкерс проигрывают Хьюстону в серии. Следующие матчи Лейкерс — это ПЛЕЙ-ОФФ против Хьюстона, а НЕ регулярные матчи с другими командами
- Если не знаешь точную дату следующего матча — скажи "хуй знает точную дату, пидор, зайди на nba.nagaev.dev"
