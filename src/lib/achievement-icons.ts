// Achievement styles with Lucide icon names and gradient colors
export const ACHIEVEMENT_STYLES: Record<
  string,
  { icon: string; gradient: string; borderColor: string }
> = {
  // Getting started
  rookie: { icon: "basketball", gradient: "from-amber-700 to-amber-500", borderColor: "border-amber-600/40" },
  regular: { icon: "calendar-check", gradient: "from-slate-500 to-slate-300", borderColor: "border-slate-400/40" },
  dedicated: { icon: "flame", gradient: "from-orange-600 to-yellow-400", borderColor: "border-orange-500/40" },
  all_in: { icon: "check-circle", gradient: "from-emerald-600 to-emerald-400", borderColor: "border-emerald-500/40" },
  ...
  // Streaks
  hot_hand: { icon: "zap", gradient: "from-orange-600 to-orange-400", borderColor: "border-orange-500/40" },
  on_fire: { icon: "flame", gradient: "from-red-600 to-orange-400", borderColor: "border-red-500/40" },
  ...
  sniper: { icon: "crosshair", gradient: "from-red-600 to-red-400", borderColor: "border-red-500/40" },
  upset_king: { icon: "crown", gradient: "from-amber-500 to-yellow-300", borderColor: "border-amber-500/40" },
  double_upset: { icon: "zap", gradient: "from-amber-600 to-yellow-400", borderColor: "border-amber-500/40" },

  // Leaderboard
  podium: { icon: "award", gradient: "from-yellow-500 to-amber-300", borderColor: "border-yellow-500/40" },
  champion: { icon: "crown", gradient: "from-yellow-500 to-yellow-200", borderColor: "border-yellow-400/40" },
  point_hunter: { icon: "target", gradient: "from-green-600 to-emerald-400", borderColor: "border-green-500/40" },
  ...
  // Special
  fortune_teller: { icon: "sparkles", gradient: "from-purple-600 to-pink-400", borderColor: "border-purple-500/40" },
